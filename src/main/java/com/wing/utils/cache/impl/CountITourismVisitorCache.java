...
import com.wing.controller.restful.RestfulController;
...
@Component
public class CountITourismVisitorCache implements DataCache{

	// ~ Static Fields
	// ==================================================

	private static final Logger logger = LogManager.getLogger(CountITourismVisitorCache.class.getName());
	...
	private final Cache cache = cacheManager.getCache("countITourismVisitor");
